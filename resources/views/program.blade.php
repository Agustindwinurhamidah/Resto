...
<head>
    ...
    <title>Entertaiment Resto</title>
    ...
    <link rel="stylesheet" href="{{url('vendor/owlcarousel/owl.carousel.min.css')}}">
                ...
                <div class="d-flex flex-lg-row flex-column">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                          @foreach($list['news'] as $news)
                          <a class="dropdown-item" href="{{url('news/'.$news->slug)}}">{{$news->title}}</a>
                          @endforeach
                        </div>
                    </li>
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                          ...
                          <a class="dropdown-item" href="{{url('products/'.$products->slug)}}">{{$products->title}}</a>
                          @endforeach
                        </div>
                    </li>
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                          @foreach($list['programs'] as $programs)
                          <a class="dropdown-item" href="{{url('programs/'.$programs->slug)}}">{{$programs->title}}</a>
                          @endforeach
                        </div>
                    </li>
                </div>
...
<section id="gtco-welcome" class="bg-white section-padding">
    <div class="container">
        <div class="section-content">
            <div class="row">
                <div class="col-sm-5 img-bg d-flex shadow align-items-center justify-content-center justify-content-md-end img-2" style="background-image: url({{$data->image}});">
...
<!-- End of Welcome Section -->     <footer class="mastfoot pb-5 bg-white section-padding pb-0">
    ...
    <script src="{{url('vendor/bootstrap/popper.min.js')}}"></script>
    ...
    <script src="{{url('vendor/stellar/jquery.stellar.js')}}" type="text/javascript" charset="utf-8"></script>
